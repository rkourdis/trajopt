...
def create_state_vector(robot: pin.RobotWrapper, joint_angles: dict[str, float]) -> np.ndarray:
    q_quat = np.expand_dims(pin.neutral(robot.model), axis = -1)    # 19x1 for Solo
